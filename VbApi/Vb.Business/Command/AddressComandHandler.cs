...
{
    public class AddressComandHandler : IRequestHandler<CreateAddressCommand, ApiResponse<AddressResponse>>,
    ...
    IRequestHandler<DeleteAddressCommand, ApiResponse>
    {
        ...
        public AddressComandHandler(VbDbContext dbContext, IMapper mapper)
        {
